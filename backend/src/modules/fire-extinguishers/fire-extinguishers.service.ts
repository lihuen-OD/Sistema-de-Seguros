...
const IMPORTANT_FIELD_MAP: { dbKey: string; dtoKey: keyof UpdateFireExtinguisherDTO }[] = [
  ...
  { dbKey: 'iramCertificateNumber', dtoKey: 'iramCertificateNumber' },
...
function mapFireExt(fe: Record<string, unknown>) {
  ...
  return {
    ...
    iramCertificateNumber: fe.iramCertificateNumber ?? null,
      ...
      .$transaction(async (tx) => {
        const created = await tx.fireExtinguisher.create({
          data: {
            ...
            iramCertificateNumber: data.iramCertificateNumber ?? null,
        ...
        await recordHistoryEntry(tx, created.id, {
          ...
          newData: {
            ...
            iramCertificateNumber: created.iramCertificateNumber,
      ...
      .$transaction([
        prisma.fireExtinguisher.update({
          ...
          data: {
            ...
            ...(data.iramCertificateNumber !== undefined && { iramCertificateNumber: data.iramCertificateNumber }),
