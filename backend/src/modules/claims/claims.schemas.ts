...
export const CLAIM_TYPES = [
  ...
  'inundacion', 'daños', 'daños_electricos', 'rotura_mecanica',
  'responsabilidad_civil', 'muerte_accidental', 'incapacidad', 'otro',
] as const

export const CLAIM_STATUSES = [
  'denunciado', 'en_tramite', 'liquidado', 'rechazado', 'cerrado',
] as const
...
const ClaimBaseSchema = z.object({
  ...
  status: z.enum(CLAIM_STATUSES).default('denunciado'),
...
export const AddEventSchema = z.object({
  ...
  date: ISODate,
  previousStatus: z.enum(CLAIM_STATUSES).optional().nullable(),
  newStatus: z.enum(CLAIM_STATUSES).optional().nullable(),
