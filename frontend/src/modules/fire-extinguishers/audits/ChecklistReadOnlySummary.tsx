import { optionLabel, type ChecklistFieldConfig } from './checklistConfig'
...
export function ChecklistReadOnlySummary({ fields, checklist, comments }: ChecklistReadOnlySummaryProps) {
  return (
    <div>
