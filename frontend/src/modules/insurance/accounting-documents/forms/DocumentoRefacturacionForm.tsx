...
export default function DocumentoRefacturacionForm({ initialDoc }: DocumentoRefacturacionFormProps) {
  ...
  return (
    <PageContent>
      <PageHeader
        title={isEdit ? `Editar ${initialDoc!.documentNumber}` : 'Nueva Refacturación'}
        subtitle="Reemplaza o corrige una factura original — no debe duplicar costos"
      ...
      <form onSubmit={handleSubmit} className="max-w-5xl space-y-5">
        <SectionCard title="Identificación" subtitle="Compañía, factura original y datos del documento">
          <FormSection title="">
            ...
            {isEdit ? (
              <FormField label="N° de Nueva Factura/Documento">
              ...
              <FormField label="N° de Nueva Factura/Documento" required error={errors.documentNumber}>
                <FormInput placeholder="Ej: 0001-00015000-RF1" value={form.documentNumber} onChange={set('documentNumber')} required />
            ...
            <FormField label="Factura Original a Refacturar" required error={errors.linkedDocumentId} fullWidth>
            ...
            <FormField label="Motivo de Refacturación" fullWidth>
              <FormTextarea rows={2} value={form.description} onChange={set('description')} placeholder="Ej: corrección de importe, cambio de condiciones…" />
            </FormField>
          </FormSection>
        </SectionCard>
