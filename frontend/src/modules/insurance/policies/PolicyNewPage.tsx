...
export default function PolicyNewPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (!validate()) return
    alert('Póliza guardada exitosamente (simulación). En producción se conectará al backend.')
  ...
  return (
    <PageContent>
      ...
      <form onSubmit={handleSubmit} className="max-w-5xl space-y-5">
        ...
        <SectionCard
          title="Importes"
          subtitle="Suma asegurada y tipo de cambio al momento de alta"
        >
          <FormSection title="">
